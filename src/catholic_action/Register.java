...
public class Register extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("NEW MEMBER REGISTRATION FORM");
        ...
        txtLastName.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(51, 153, 255)));
        ...
        txtFirstName.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(51, 153, 255)));
        ...
        txtRegNumber.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(51, 153, 255)));

        txtPhone.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        txtPhone.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtPhone.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(51, 153, 255)));
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtFirstName, txtLastName, txtPhone, txtRegNumber});
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtFirstName, txtLastName, txtPhone, txtRegNumber});
        ...
        cboJumuiya.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--Select--Jumuiya--", "St.Peters", "St.Bridgits", "St.Charles", "Holy Family", "St.Thomas Aquinas", "St.Stephenes", "Guest" }));
        ...
        txtParish.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(51, 153, 255)));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboCourse, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            String year=(String) cboYear.getSelectedItem();
            ...
            if(txtFirstName.getText().equals("")){
             ...
             else if(cboJumuiya.getSelectedIndex()==0){
                    cboJumuiya.setBorder(new LineBorder(Color.red));
                      JOptionPane.showMessageDialog(this,"your Jumuiya is required.");
                   } 
                    ...
                    cboYear.setBorder(new LineBorder(Color.red));
                      JOptionPane.showMessageDialog(this,"Please select your Year of study.");
                    }
            ...
            else if(cboCourse.getSelectedItem().equals("")){
